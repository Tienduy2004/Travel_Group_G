                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="w-full md:w-2/3">
                        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="hoTen_main" id="hoTen" class="w-full p-2 border rounded"
                                        placeholder="Nhập họ tên" />
                                </div>
                                <div>
                                    <label for="dienThoai" class="block mb-1">Điện thoại *</label>
                                    <input type="tel" name="dienThoai_main" id="dienThoai"
                                        class="w-full p-2 border rounded" placeholder="Nhập số điện thoại" />
                                </div>
                                <div>
                                    <label for="email" class="block mb-1">Email *</label>
                                    <input type="email" name="email_main" id="email" class="w-full p-2 border rounded"
                                        placeholder="Nhập email" />
                                </div>
                                <div>
                                    <label for="diaChi" class="block mb-1">Địa chỉ</label>
                                    <input type="text" name="diaChi_main" id="diaChi"
                                        class="w-full p-2 border rounded" placeholder="Nhập địa chỉ" />
                                </div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <div class="flex items-center">
                                    <button onclick="decrement('adultCount')" class="px-3 py-1 border rounded-l">-</button>
                                    <input type="text" id="adultCount" value="1" readonly
                                        class="w-12 text-center border-t border-b" />
                                    <button onclick="increment('adultCount')" class="px-3 py-1 border rounded-r">+</button>
                                </div>
                            </div>
                            <div class="flex justify-between items-center">
                                <span>Trẻ em</span>
                                <div class="flex items-center">
                                    <button onclick="decrement('childCount')" class="px-3 py-1 border rounded-l">-</button>
                                    <input type="text" id="childCount" value="0" readonly
                                        class="w-12 text-center border-t border-b" />
                                    <button onclick="increment('childCount')" class="px-3 py-1 border rounded-r">+</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                            ...
                            <div class="flex items-center mb-4">
                                <input type="checkbox" id="vietnameseNationality" class="mr-2" />
                            ...
                            <div id="passengerInfoContainer">
                                <div class="mb-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-4 mb-4">
                                        ...
                                        <input type="text" placeholder="Ngày sinh" class="p-2 border rounded" />
                                        <div class="relative">
                                            <select class="w-full p-2 border rounded appearance-none">
                                    ...
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <input type="checkbox" id="singleRoomToggle${i + 1}"
                                                class="react-switch-checkbox hidden"
                                                onchange="handleSingleRoomToggle(this, ${i + 1})">
                                            <label for="singleRoomToggle${i + 1}"
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" id="payment-1" name="paymentMethod" class="mr-2" />
                                    <label for="payment-1">Tiền mặt</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="payment-2" name="paymentMethod" class="mr-2" />
                    ...
                    <div class="w-full md:w-1/3">
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Mã Tour: NDDN0703-016-290324N-D</p>
                            ...
                            <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded-md mb-2">Tiếp tục
                                đặt tour</button>
                            <button class="w-full border border-blue-600 text-blue-600 py-2 rounded-md">Liên hệ tư
                                vấn</button>
                        </div>
                    </div>
                    <div class="w-full md:w-1/3">
    ...
    <script>
        ...
        function updatePassengerInfo() {
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-4">
                        <label class="block mb-1">Phòng đơn</label>
                        <input type="checkbox" id="singleRoomToggle${i + 1}" class="react-switch-checkbox hidden" onchange="handleSingleRoomToggle(this, ${i + 1})">
        ...
        `;
            ...
            for (let j = 0; j < childCount; j++) {
                const childInfo = `
            <div class="mb-4">
                <label class="block mb-1">Trẻ em ${j + 1}</label>
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <input type="text" placeholder="Họ tên" class="p-2 border rounded" />
                    <input type="text" placeholder="Ngày sinh" class="p-2 border rounded" />
                    <div class="relative">
