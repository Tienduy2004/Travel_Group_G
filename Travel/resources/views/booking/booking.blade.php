                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="w-full md:w-2/3">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" id="payment-1" name="paymentMethod" value="cash"
                                        class="mr-2" required />
                                    <label for="payment-1">Tiền mặt</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="payment-2" name="paymentMethod" value="transfer"
                                        class="mr-2" required />
                    ...
                    <div class="w-full md:w-1/3">
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <input id="totalAmount_input" type="hidden" name="total_price"
                                value="{{ $total_price }}">
